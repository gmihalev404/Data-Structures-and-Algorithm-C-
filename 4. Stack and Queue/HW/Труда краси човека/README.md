...
Дадени са в $N$ цели числа $p_0, \dots, p_{N-1}$, които представляват трудолюбието на всеки един човек от селото, и цяло число $K$. Вашата задача е да намерите сумата на трудолюбивостта на най-мързеливите хора в селото. Тоест трябва да намерите сумата на минималните елементи на всички подмножества с дължина $k$. Като елементите в едно подмножество са последователни.

* $\sum_{i=0}^{N-k} \min(p_i, p_{i+1}, \dots, p_{i+k-1})$ (Кмета е завършил ФМИ и може да се изказва математически издържано).
...
Следват $N$ на брой цели числа - стойностите на $p_0, \dots, p_{N-1}$.
...
Минималните елементи във всички подмасиви с дължина 4 са съответно: 1, 2, 2, 2, 2, 4, 4. **Като ги съберем:** $1 + 2 + 2 + 2 + 2 + 4 + 4 = 17$.
